...
# TODO JL 3/12/25: edit this to plot facets as video

from visit_utils import *


def plot_facets(
    facetformat="timestep_{}_all.visit", saveformat="facets_%04d.png", tfinal=100
):
    ...
    for ts in range(tfinal + 1):
        ...
        MeshAtts.meshColorSource = (
            MeshAtts.MeshCustom
        )  # Foreground, MeshCustom, MeshRandom
        MeshAtts.opaqueColorSource = (
            MeshAtts.Background
        ...
        MeshAtts.pointType = (
            MeshAtts.Point
        )  # Box, Axis, Icosahedron, Octahedron, Tetrahedron, SphereGeometry, Point, Sphere
