...
REPRESENTATIVE_CASES = {
    ...
    "squares": {
        ...
        "methods": [
            ...
            ("LVIRA", "LVIRA"),
            ("linear", "Ours (linear)"),
            ("linear+corner", "Ours (linear + corners)"),
        ],
        "min_span": 42.0,
        "margin_frac": 0.10,
    ...
    "zalesak": {
        ...
        "methods": [
            ...
            ("LVIRA", "LVIRA"),
            ("circular", "Ours (circular)"),
            ("circular+corner", "Ours (circular + corners)"),
        ],
        "min_span": 42.0,
        "margin_frac": 0.12,
...
APPENDIX_BEST_METHODS = {
    ...
    "squares": {
        "method": ("linear+corner", "Ours (linear + corners)"),
    ...
    "zalesak": {
        "method": ("circular+corner", "Ours (circular + corners)"),
        "resolutions": [0.50, 0.64, 1.0, 1.5],
        "wiggle": 0.10,
        "seed": 0,
        "case_index": 20,
