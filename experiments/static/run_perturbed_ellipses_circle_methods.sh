...
#
# Usage:
#   ./experiments/static/run_perturbed_ellipses_circle_methods.sh
#
...
LOG_DIR="logs/perturbed_ellipse_circle_methods_${STAMP}"
mkdir -p "$LOG_DIR"

echo "=========================================="
echo "Perturbed circle-method sweep (ellipses)"
echo "=========================================="
  ...
  for resolution in "${RESOLUTIONS[@]}"; do
    for wiggle in "${WIGGLES[@]}"; do
      for seed in "${SEEDS[@]}"; do
        ...
        rtag="${resolution//./p}"
        wtag="${wiggle//./p}"
        save_name="perturb_sweep_ellipses_${method}_r${rtag}_w${wtag}_s${seed}"
