    ...
    def runSafeLinear(self, ret=False, check_threshold=False, default_to_youngs=True):
        ...
        if orientation is None:
            ...
            if check_threshold:
                ...
                if abs(self.getFraction() - getPolyLineArea(self.points, l1, l2)/self.getMaxArea()) < BasePolygon.linearity_threshold and (getPolyLineArea(self.points, l1, l2)/self.getMaxArea() > BasePolygon.fraction_tolerance) and (getPolyLineArea(self.points, l1, l2)/self.getMaxArea() < 1-BasePolygon.fraction_tolerance):
                    # Linear: set facet
                    # intersects = getPolyLineIntersects(self.points, l1, l2)
